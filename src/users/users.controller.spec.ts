...
describe('UsersController', () => {
  ...
  describe('getAllusers', () => {
    it('should return an array of users', async () => {
      const expected = [
        { id: 1, firstname: 'John', lastname: 'Doe', age: 23, name: 'John Doe', email: 'john.doe@example.com', password: 'password123' },
        { id: 2, firstname: 'Jane', lastname: 'Doe', age: 28, name: 'Jane Doe', email: 'jane.doe@example.com', password: 'password123' },
      ];
  ...
  describe('getbyId', () => {
    it('should return a user by ID', async () => {
      const userId = 1;
      const expected = { id: userId, firstname: 'John', lastname: 'Doe', age: 23, name: 'John Doe', email: 'john.doe@example.com', password: 'password123' };
  ...
  describe('create', () => {
    it('should create a new user', async () => {
      const userInput = { firstname: 'New', lastname: 'User', age: 30, name: 'New User', email: 'new.user@example.com', password: 'password123' };
  ...
  describe('updatebyId', () => {
    it('should update a user by ID', async () => {
      const userId = 1;
      const userInput = { firstname: 'Updated', lastname: 'User', age: 25, name: 'Updated User', email: 'updated.user@example.com', password: 'password123' };
      const expected = { id: userId, ...userInput, name: 'Updated User', email: 'updated.user@example.com', password: 'password123' };
